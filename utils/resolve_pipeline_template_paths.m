...
dartelCandidates = unique(nonempty([ ...
    ...
    map_roots(spmRoots, {'toolbox','DARTEL','Template_6.nii'}), ...
    map_roots(spmRoots, {'tpm','TPM.nii'}), ...
...
t1TemplateCandidates = unique(nonempty([ ...
    ...
    map_roots(spmRoots, {'toolbox','OldNorm','icbn152.nii'}), ...
    map_roots(spmRoots, {'toolbox','OldNorm','icbm152.nii'}), ...
